{
  ...
  storage: {
    ...
    output: {
      tables: [
        {
          destination: "out.c-ecommerce-bdm-" + ConfigId("in-ecommerce-googleads-extractor-15228151") + ".bdmMarketingCampaignCosts",
        ...
        {
          destination: "out.c-ecommerce-bdm-" + ConfigId("in-ecommerce-googleads-extractor-15228151") + ".bdmMarketingCampaignCostsMonthly",
