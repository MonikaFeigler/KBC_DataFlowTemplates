...
FROM "order"
  ...
  SELECT "shipping_address__city", "shipping_address__country", O."customer_id"
  FROM "order" O JOIN "last_order" LO ON LO."id" = O."id";
...
FROM "customer" C
JOIN "last_shipping_address" LS ON LS."customer_id"=C."id";
