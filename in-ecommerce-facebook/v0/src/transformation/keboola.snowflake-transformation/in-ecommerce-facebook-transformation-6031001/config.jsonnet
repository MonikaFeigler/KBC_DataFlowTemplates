{
  ...
  storage: {
    ...
    output: {
      tables: [
        {
          destination: "out.c-ecommerce-bdm-" + ConfigId("in-ecommerce-facebook-extractor-6031001") + ".bdm_marketing_campaign_costs",
        ...
        {
          destination: "out.c-ecommerce-bdm-" + ConfigId("in-ecommerce-facebook-extractor-6031001") + ".bdm_marketing_campaign_costs_monthly",
