{
  storage: {
    input: {
      tables: [
        {
          source: "out.c-thoughtspot-wr-10708760.HUBSPOT_MARKETING_EMAIL",
          destination: "out.c-thoughtspot-wr-10708760.HUBSPOT_MARKETING_EMAIL.csv",
          changed_since: "",
          columns: [
            "EMAIL_URL",
            "DATE_CREATED",
    ...
    tables: [
      {
        ...
        tableId: "out.c-thoughtspot-wr-10708760.HUBSPOT_MARKETING_EMAIL",
        incremental: false,
        items: [
          {
            name: "EMAIL_URL",
