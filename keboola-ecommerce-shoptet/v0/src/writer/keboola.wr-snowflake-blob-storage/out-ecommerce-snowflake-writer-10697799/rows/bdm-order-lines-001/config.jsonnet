{
  parameters: {
    tableId: "out.c-ecommerce-wr-6031003.bdm_order_lines",
  ...
  storage: {
    input: {
      tables: [
        {
          source: "out.c-ecommerce-wr-6031003.bdm_order_lines",
          destination: "out.c-ecommerce-wr-6031003.bdm_order_lines.csv",
          columns: [
            "ORDER_ID",
            "ORDER_LINE_ID",
            "ORDER_DATE",
