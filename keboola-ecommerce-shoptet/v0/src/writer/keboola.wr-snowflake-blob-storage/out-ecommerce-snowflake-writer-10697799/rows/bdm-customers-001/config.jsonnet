{
  parameters: {
    tableId: "out.c-ecommerce-wr-6031003.bdm_customers",
  ...
  storage: {
    input: {
      tables: [
        {
          source: "out.c-ecommerce-wr-6031003.bdm_customers",
          destination: "out.c-ecommerce-wr-6031003.bdm_customers.csv",
          columns: [
            "CUSTOMER_ID",
            "CUSTOMER_EMAIL_HASH",
            "CUSTOMER_EMAIL",
