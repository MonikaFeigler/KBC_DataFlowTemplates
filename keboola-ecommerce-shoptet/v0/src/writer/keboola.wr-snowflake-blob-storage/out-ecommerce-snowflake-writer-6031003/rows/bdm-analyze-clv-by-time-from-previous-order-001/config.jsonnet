{
  parameters: {
    tableId: "out.c-ecommerce-wr-6031003.bdm_analyze_clv_by_time_from_previous_order",
  ...
  storage: {
    input: {
      tables: [
        {
          source: "out.c-ecommerce-wr-6031003.bdm_analyze_clv_by_time_from_previous_order",
          destination: "out.c-ecommerce-wr-6031003.bdm_analyze_clv_by_time_from_previous_order.csv",
          columns: [
