{
  ...
  storage: {
    ...
    output: {
      tables: [
        {
          destination: "out.c-ecommerce-bdm-" + ConfigId("in-ecommerce-sklik-extractor-6031007") + ".bdm_marketing_campaign_costs",
        ...
        {
          destination: "out.c-ecommerce-bdm-" + ConfigId("in-ecommerce-sklik-extractor-6031007") + ".bdm_marketing_campaign_costs_monthly",
          primary_key: [
            "MARKETING_CAMPAIGN_COSTS_ID",
          ],
