{
  parameters: {
    tableId: "out.c-activity-center.snowflake_statistics",
  ...
  storage: {
    input: {
      tables: [
        {
          source: "out.c-activity-center.snowflake_statistics",
          destination: "out.c-activity-center.snowflake_statistics.csv",
          columns: [
            "snowflake_job_id",
            "project_id",
