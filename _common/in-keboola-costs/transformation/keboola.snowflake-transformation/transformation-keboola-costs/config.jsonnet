  ...
  storage: {
    input: {
      tables: [
        ...
        {
          source: "in.c-keboola-ex-telemetry-data-" + ConfigId("telemetry-keboola-costs") + ".kbc_organization",
        ...
        {
          source: "in.c-keboola-ex-telemetry-data-" + ConfigId("telemetry-keboola-costs") + ".kbc_data_science_sandbox",
