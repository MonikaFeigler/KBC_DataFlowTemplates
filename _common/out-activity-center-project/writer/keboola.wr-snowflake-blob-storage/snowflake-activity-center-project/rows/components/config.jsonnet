{
  parameters: {
    tableId: "out.c-activity-center-project.components",
    dbName: "components",
    incremental: true,
    primaryKey: [
      "component_id",
  ...
  storage: {
    input: {
      tables: [
        {
          source: "out.c-activity-center-project.components",
          destination: "out.c-activity-center-project.components.csv",
          columns: [
            "component_id",
            "component_name",
            "component_type",
