{
  parameters: {
    tableId: "out.c-activity-center-project.buckets_metrics",
  ...
  storage: {
    input: {
      tables: [
        {
          source: "out.c-activity-center-project.buckets_metrics",
          destination: "out.c-activity-center-project.buckets_metrics.csv",
          columns: [
            "bucket_snapshot_id",
            "bucket_id",
            "bucket_project_id",
