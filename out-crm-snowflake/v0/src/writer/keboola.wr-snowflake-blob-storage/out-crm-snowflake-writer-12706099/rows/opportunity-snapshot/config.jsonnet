{
  parameters: {
    tableId: "out.c-crm-bdm-"+ConfigId("out-crm-snowflake-writer-12706099")+".opportunity_snapshot",
  ...
  storage: {
    input: {
      tables: [
        {
          source: "out.c-crm-bdm-"+ConfigId("out-crm-snowflake-writer-12706099")+".opportunity_snapshot",
          destination: "out.c-crm-bdm-"+ConfigId("out-crm-snowflake-writer-12706099")+".opportunity_snapshot.csv",
          columns: [
            "opportunity_id",
            "snapshot_date",
            "employee_id",
