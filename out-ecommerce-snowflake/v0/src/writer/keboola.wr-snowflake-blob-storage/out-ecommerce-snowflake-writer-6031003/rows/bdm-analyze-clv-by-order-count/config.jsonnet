{
  parameters: {
    tableId: "out.c-ecommerce-wr-6031003.bdm_analyze_clv_by_order_count",
  ...
  storage: {
    input: {
      tables: [
        {
          source: "out.c-ecommerce-wr-6031003.bdm_analyze_clv_by_order_count",
          destination: "out.c-ecommerce-wr-6031003.bdm_analyze_clv_by_order_count.csv",
          columns: [
