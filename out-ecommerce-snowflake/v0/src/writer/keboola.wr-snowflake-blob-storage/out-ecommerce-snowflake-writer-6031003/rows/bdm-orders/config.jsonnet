{
  parameters: {
    tableId: "out.c-ecommerce-wr-6031003.bdm_orders",
    dbName: "bdm_orders",
    incremental: false,
    primaryKey: [
      "ORDER_ID",
    ...
    items: [
      ...
      {
        name: "ORDER_CURRENCY_FX_RATE",
        dbName: "ORDER_CURRENCY_FX_RATE",
        type: "varchar",
        nullable: true,
        default: "",
        size: "16777216",
      ...
      {
        name: "ORDER_SHOP_REMARK",
        dbName: "ORDER_SHOP_REMARK",
        type: "varchar",
        nullable: true,
        default: "",
        size: "16777216",
      ...
      {
        name: "ORDER_PRICE_ROUNDING",
        dbName: "ORDER_PRICE_ROUNDING",
        type: "varchar",
        nullable: true,
        default: "",
        size: "16777216",
      ...
      {
        name: "ORDER_TOTAL_PRICE_TO_PAY",
        dbName: "ORDER_TOTAL_PRICE_TO_PAY",
        type: "varchar",
        nullable: true,
        default: "",
        size: "16777216",
  ...
  storage: {
    input: {
      tables: [
        {
          source: "out.c-ecommerce-wr-6031003.bdm_orders",
          destination: "out.c-ecommerce-wr-6031003.bdm_orders.csv",
          columns: [
            "ORDER_ID",
            "ORDER_DATE",
            "ORDER_STATUS",
