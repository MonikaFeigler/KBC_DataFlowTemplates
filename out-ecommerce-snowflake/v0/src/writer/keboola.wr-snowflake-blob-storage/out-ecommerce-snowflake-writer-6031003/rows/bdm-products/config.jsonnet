{
  parameters: {
    tableId: "out.c-ecommerce-wr-6031003.bdm_products",
    dbName: "bdm_products",
    incremental: false,
    primaryKey: [
      "PRODUCT_ID",
  ...
  storage: {
    input: {
      tables: [
        {
          source: "out.c-ecommerce-wr-6031003.bdm_products",
          destination: "out.c-ecommerce-wr-6031003.bdm_products.csv",
          columns: [
            "PRODUCT_ID",
            "PRODUCT_CODE",
            "PRODUCT_CODE_2",
