{
  parameters: {
    tableId: "out.c-ecommerce-bdm-" + ConfigId("out-ecommerce-snowflake-writer-10697799") + ".bdm_order_lines",
  ...
  storage: {
    input: {
      tables: [
        {
          source: "out.c-ecommerce-bdm-" + ConfigId("out-ecommerce-snowflake-writer-10697799") + ".bdm_order_lines",
          destination: "out.c-ecommerce-bdm-" + ConfigId("out-ecommerce-snowflake-writer-10697799") + ".bdm_order_lines.csv",
          columns: [
            "ORDER_ID",
            "ORDER_LINE_ID",
            "ORDER_DATE",
