{
  parameters: {
    tableId: "out.c-ecommerce-bdm-" + ConfigId("out-ecommerce-snowflake-writer-10697799") + ".bdm_orders",
    dbName: "bdm_orders",
    incremental: false,
    primaryKey: [
      "ORDER_ID",
  ...
  storage: {
    input: {
      tables: [
        {
          source: "out.c-ecommerce-bdm-" + ConfigId("out-ecommerce-snowflake-writer-10697799") + ".bdm_orders",
          destination: "out.c-ecommerce-bdm-" + ConfigId("out-ecommerce-snowflake-writer-10697799") + ".bdm_orders.csv",
          columns: [
            "ORDER_ID",
            "ORDER_DATE",
            "ORDER_STATUS",
