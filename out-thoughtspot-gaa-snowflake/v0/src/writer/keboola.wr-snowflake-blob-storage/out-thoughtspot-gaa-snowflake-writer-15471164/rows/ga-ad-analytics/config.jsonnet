{
  parameters: {
    tableId: "out.c-thoughtspot-wr-15471164.ga_ad_analytics",
  ...
  storage: {
    input: {
      tables: [
        {
          source: "out.c-thoughtspot-wr-15471164.ga_ad_analytics",
          destination: "out.c-thoughtspot-wr-15471164.ga_ad_analytics.csv",
          columns: [
            "id_TBE",
            "ga_date",
            "ga_adGroup",
