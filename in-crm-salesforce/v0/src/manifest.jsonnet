{
  configurations: [
    ...
    {
      componentId: "keboola.orchestrator",
      id: ConfigId("out-crm-salesforce-orchestration-bdm-usage-12706099"),
      path: "other/keboola.orchestrator/out-crm-salesforce-orchestration-bdm-usage-12706099",
      rows: [],
    },
    {
    ...
    },
    {
      ...
      rows: [
        ...
        {
          id: ConfigRowId("contact-001"),
          path: "rows/contact-001",
        },
        {
        ...
        {
          id: ConfigRowId("opportunity-001"),
          path: "rows/opportunity-001",
        },
        {
