{
  parameters: {
    tableId: "out.c-activity-center.configurations_versions",
  ...
  storage: {
    input: {
      tables: [
        {
          source: "out.c-activity-center.configurations_versions",
          destination: "out.c-activity-center.configurations_versions.csv",
          columns: [
            "component_configuration_version_id",
